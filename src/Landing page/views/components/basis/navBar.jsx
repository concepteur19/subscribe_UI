            ...
            <div className="flex justify-center pt-7 pb-1 px-8 max-sm:px-4">
                <div className="flex justify-between items-center w-full mx-auto max-w-[1276.8px]">
                    ...
                    <div className="nav-links flex items-center max-lg:hidden">
                        <a href="#" className="px-[10px] py-[14px] text-white text-[15.5px]">Product</a>
                        <a href="#" className="px-[10px] py-[14px] text-white text-[15.5px]">Feature</a>
                        <a href="#" className="px-[10px] py-[14px] text-white text-[15.5px]">How it work</a>
                        <a href="#" className="px-[10px] py-[14px] text-white text-[15.5px]">Company</a>
                    </div>
