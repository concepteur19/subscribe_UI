...
import dashboardPhone from '../../../elements/dashboardPhone.svg';
        ...
        <>
            <div className='px-8 max-sm:px-4'>
                <div className="flex flex-col justify-center items-center gap-[96.5px] mt-[105px] pb-[199.91px] mx-auto max-w-[1276.8px] max-sm:mt-[85px] max-sm:pb-[80px]">
                    ...
                    <div className="flex flex-col justify-center items-center max-w-[1276.8px] w-full h-[748.09px] rounded-[24px] max-lg:h-[573px]">
                        ...
                        <img src={dashboardPhone} className='hidden max-sm:block' alt=''/>
                    </div>
                </div>
            </div>
