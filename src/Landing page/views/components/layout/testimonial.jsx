            ...
            <div className="pb-[85px] px-8 max-sm:px-4 ">
                <div className="flex flex-col items-center gap-[66.14px] mx-auto max-w-[1276.8px] w-full">
                    <div className="flex flex-col items-center gap-[20px]">
                        <h2 className='text-[52.74px] leading-[110%] tracking-[-1.34px] font-bold text-white text-center max-w-[560px] max-sm:text-[32px]'>Features that meet the specific needs of users</h2>
                    ...
                    <div className="inline-flex items-center gap-3 max-[875px]:flex-col">
                        <div className="p-[58px] inline-flex flex-col border border-solid border-[#0B0B20] rounded-[16px] max-xl:p-[30px] max-lg:px-[10px] max-[875px]:px-[18px] max-sm:w-full">
