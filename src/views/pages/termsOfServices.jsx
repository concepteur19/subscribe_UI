        ...
        <>
            <div className="px-3">
                <div className="flex flex-col gap-2 mx-auto md:max-w-lg w-full my-4">
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">By downloading or using the app, chrome extension and website, these terms will automatically apply to you – you
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">Subs Tracker ("subs.is", "we", "us", and/or "our") built the Subs Tracker is committed to ensuring that the app is as useful and efficient 
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">The Subs Tracker app stores and processes personal data that you have provided to us, to provide my Service. It’s your responsibility to 
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">The app does use third-party services that declare their Terms and Conditions. Link to Terms and Conditions of third-party service providers used by the app</p>

                    <h2>Google Play Services</h2>
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">You should be aware that there are certain things that subs.is will not take responsibility for. Certain functions of the app will require the app 
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">If you’re using the app outside of an area with Wi-Fi, you should remember that the terms of the agreement with your mobile network provider will still apply. 
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">Along the same lines, subs.is cannot always take responsibility for the way you use the app i.e. You need to make sure that your device stays charged – if it runs out of battery and 
                    you can’t turn it on to avail the Service, subs.is cannot accept responsibility.</p>

                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">With respect to subs.is responsibility for your use of the app, when you’re using the app, it’s important to bear in mind that although we endeavor to ensure that it is updated and correct 
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">At some point, we may wish to update the app. The app is currently available on – the requirements for the system(and for any additional systems we decide to extend the availability of the app to) 
                    ...
                    <p className="text-[#BBBBC8] text-[16px] leading-[150%]">Subs Tracker may update our Terms and Conditions from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new Terms and Conditions on this page.
