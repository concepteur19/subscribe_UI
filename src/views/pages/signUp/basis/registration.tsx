...
const RegistrationPageElements: FC= () => {
  ...
  const [errors, setErrors] = useState<RegistrationPops>({
    email: "",
    username: "",
    password: "",
    confirmPassword: "",
    ...
    <>
      ...
      >
        <div className="hero-section-content flex flex-col items-center pt-10">
          ...
          >
            <form
              className="registration-card-content flex flex-col items-start gap-6 "
...
export default RegistrationPageElements;
