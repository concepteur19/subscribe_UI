...
import spotify from '../../../../assets/images/youtube.svg'; 
import primeVideo from '../../../../assets/images/youtube.svg'; 
...
const ConnexionPageElements: FC = () => {
  const [Data, setData] = useState<LoginPops>({
    email: "",
    password: "",
  });

  const [errors, setErrors] = useState<LoginPops>({
    email: "",
    password: "",
  });
    ...
    <>
      ...
      >
        <div className="hero-section-content flex flex-col items-center pt-28">
          ...
          >
            <form
              className="connexion-card-content flex flex-col items-start gap-6"
        ...
        <img
          src={youtube}
          alt=""
          className="youtube-widget max-xl:hidden"
          style={{
            position: "absolute",
            right: "-5%",
            top: "58px",
        ...
        <img
          src={netflix}
          alt=""
          className="netflix-widget max-xl:hidden"
          style={{
            position: "absolute",
            right: "0%",
            top: "420px",
        ...
        <img
          src={spotify}
          alt=""
          className="spotify-widget max-xl:hidden"
          style={{
            position: "absolute",
            left: "0%",
            top: "102px",
        ...
        <img
          src={primeVideo}
          alt=""
          className="prime-video-widget max-xl:hidden"
          style={{
            position: "absolute",
            left: "0%",
            top: "470px",
...
export default ConnexionPageElements;
