...
export function ConnexionPageElements(){
        ...
        <>
            ...
            >
                <div className="hero-section-content flex flex-col items-center pt-28">
                    <div className="connexion-card flex bg-white"
                        style={{
                            padding: "20px 30px",
                            borderRadius: "14px",
                        }}
                    >
                        <form className="connexion-card-content flex flex-col items-start gap-6" onSubmit={handleSubmit}>
