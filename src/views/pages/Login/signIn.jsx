                        ...
                        <form className='flex flex-col items-start gap-6 w-full' onSubmit={handleSubmit}>
                            ...
                            <div className='flex flex-col gap-4 w-full'>
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="email" className='text-[#000] font-medium text-[14px]'>Email</label>
                                    <input
                                        type="email"
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="password" className='text-[#000] font-medium text-[14px]'>Password</label>
                                    <input
                                        type="password"
                                        placeholder="********"
                                        name="password"
